...
# based on code found here: https://gist.github.com/blelump/9e6880a87fefa6397032

module AwsmaRails
  class AwsSignedRequestV4
    ...
    # @param [Net::HTTP::Post] or [Net::HTTP::Get] req
    # @return [Net::HTTP::Post] or [Net::HTTP::Get] the signed request.
    def sign(req)
